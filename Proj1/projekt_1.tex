...
\end{align}
Damit gilt für alle Polynome $ p $ mit zugehörigen Grad $ N $, dass \begin{align*}
	\tilde{p}(x) := \dfrac{b-a}{2} *p(\dfrac{b+a}{2}+x\dfrac{b-a}{2})
\end{align*}
auch vom Grad $ N $ ist. Somit ist die Ordnung der neuen Quadratur gleich der Ordnung der ursprünglichen.\\
