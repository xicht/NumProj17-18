...
Für die Gegenüberstellung wurden die Knoten auf $ [-1,1] $ auf beide Arten berechnet. Mehr Aufschluss darüber gibt die folgende Tabelle \ref{tap:Vergleich}, die einige Knoten mit 16 Stellen in den Fällen $ n=10, 30, 45 $ für den Grad der Legendre-Polynome wiedergibt.
\newline
...
\end{align}
Da die die Transformation $ \psi $ linear ist, ändert sich der Grad eines Polynoms und damit die Ordnung der Quadratur nicht.
